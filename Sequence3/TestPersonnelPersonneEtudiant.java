 ...
 * @author perringe
 */
public class TestPersonnelPersonneEtudiant {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("------------------------------------");
        Personnel per1 = new Personnel("maracasse","john","maracjo");
        Personnel per2 = new Personnel("verda","valentin","verdava");
        
        per1.setEchelon(10);
        per1.setValeurPointIndice(120);
        
        per2.setEchelon(35);
        per2.setValeurPointIndice(55);
        
        per1.setAdresse("avenue du boulevard");
        per2.setAdresse("Rue des marcassins");
